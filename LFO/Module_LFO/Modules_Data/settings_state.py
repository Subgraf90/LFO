...
class Settings:
    ...
    def load_custom_defaults(self):
        ...
        defaults = {            
            ...
            'air_pressure': 101325.0, # Standard-Luftdruck (Pa) für Akustikmodelle
            'use_air_absorption': False,  # Luftabsorption in Berechnungen verwenden
            'fem_compute_particle_velocity': True,
            'upper_calculate_frequency': 56,
            'lower_calculate_frequency': 45,
            'calculate_frequency': 50.2,
            'fem_calculate_frequency': 50,
    ...
    def to_dict(self):
        return {
            ...
            'use_air_absorption': self.use_air_absorption,
            'calculate_frequency': self.calculate_frequency,
            'fem_calculate_frequency': getattr(self, 'fem_calculate_frequency', 50),
    ...
    def add_surface_definition(self, surface_id, surface_data, make_active=False):
        ...
        old_version = self.geometry_version
        ...
        try:
            ...
            with open('/Users/MGraf/Python/LFO_Umgebung/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({
                    ...
                    "runId": "run1",
                    "hypothesisId": "B",
                    "location": "settings_state.py:363",
                    "message": "geometry_version incremented - surface added",
                    "data": {
                        "surface_id": surface_id,
                        "old_version": old_version,
                        "new_version": self.geometry_version,
                        "group_id": getattr(surface_data, "group_id", None)
                    },
            ...
            try:
                ...
                with open('/Users/MGraf/Python/LFO_Umgebung/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({
                        ...
                        "runId": "run1",
                        "hypothesisId": "B",
                        "location": "settings_state.py:376",
                        "message": "geometry_version incremented - surface removed",
                        "data": {
                            "surface_id": surface_id,
                            "old_version": old_version,
                            "new_version": self.geometry_version,
