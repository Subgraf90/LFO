...
class FlexibleGridGenerator(ModuleBase):
    ...
    def generate_group_sum_grid(
        ...
        if individual_grid_bboxes and len(individual_grid_bboxes) > 0:
            # Verwende die Bounding-Boxen der triangulierten Vertices (inkl. Edge-Refinement)
            all_x_min = [bbox[0] for bbox in individual_grid_bboxes]
            all_x_max = [bbox[1] for bbox in individual_grid_bboxes]
            all_y_min = [bbox[2] for bbox in individual_grid_bboxes]
            all_y_max = [bbox[3] for bbox in individual_grid_bboxes]
            all_z_min = [bbox[4] for bbox in individual_grid_bboxes]
            all_z_max = [bbox[5] for bbox in individual_grid_bboxes]
        ...
        padding_z = resolution * padding_factor
