...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionLoad_2.setText(_translate("MainWindow", "Open"))
        self.actionLoad_2.setShortcut(_translate("MainWindow", "Ctrl+O"))
        ...
        self.actionNew_2.setShortcut(_translate("MainWindow", "Ctrl+Shift+N"))
